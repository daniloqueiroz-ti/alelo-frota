...
public class Dbinit implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		Vehicle v1 = new Vehicle("ABC-1234", "Ford Ka 1.0", "Mercedes-Benz", "blue", true); 
		Vehicle v2 = new Vehicle("ABC-1112", "Class C 1.1 Avantgarde Turbo", "Mercedes-Benz", "blue", true);
		Vehicle v3 = new Vehicle("ABC-3344", "Montana 1.6 Avantgarde Flex", "Mercedes-Benz", "blue", true);
		Vehicle v4 = new Vehicle("ABC-5567", "Montana 1.6 Avantgarde Turbo", "Mercedes-Benz", "blue", true);
		Vehicle v5 = new Vehicle("ABC-2541", "Montana 1.6 Avantgarde Flex", "Mercedes-Benz", "blue", true);
		...
		Vehicle v12 = new Vehicle("BCA-7531", "Ford Ka 1.0", "Chevrolet", "gray", true);
